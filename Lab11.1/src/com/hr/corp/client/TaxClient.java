...
class TaxClient {
    ...
    public static void main(String[] args) {
        ...
        // Executive IS-A SalariedEmployee, and SalariedEmployee IS-A Employee,
        // and Employee IS-A TaxPayer
        // Therefore, Executive IS-A TaxPayer!
        irs.register(new Executive("Jay", LocalDate.of(2022, 2, 2), 100_000.0));
